        ...
        try:
            ...
            if total_used_today >= self.total_daily_limit and not is_admin:
                ...
                return {
                    ...
                    "is_admin": False,
                    "message": f"⚠️ 今日总配额已用尽（{total_used_today}/{self.total_daily_limit}），请明天再试。\n💡 每日00:00自动重置"
                }
            ...
            if not result.get("allowed", False):
                ...
                return {
                    ...
                    "is_admin": False,
                    "message": f"⚠️ 今日配额已用尽（{used}/{daily_limit}），请明天再试。\n💡 每日00:00自动重置"
                }
            ...
            if is_admin:
                ...
                message = f"✅ 查询成功\n💡 今日剩余配额：{remaining}/{self.daily_limit}（总配额剩余：{total_remaining}）"
    ...
    def get_usage_status(self, user_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_used_today": total_used,
                "total_limit": self.total_daily_limit,
                "message": f"📊 今日使用：{used}/{self.daily_limit} 次\n💡 总配额剩余：{total_remaining} 次"
            }
